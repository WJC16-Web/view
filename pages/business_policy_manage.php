    ...
    try {
        ...
        if ($policy_type === 'cancellation') {
            ...
            $policy_data = [
                ...
                'deposit_rate' => floatval($_POST['deposit_rate'] ?? 0.2),
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="refund-rate"><?= 100 - ($policies['cancellation']['fee_rates'][0]['fee_rate'] ?? 0) ?>%</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>12시간 전</td>
                                                    ...
                                                    <td>
                                                        <span class="refund-rate"><?= 100 - ($policies['cancellation']['fee_rates'][1]['fee_rate'] ?? 10) ?>%</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>6시간 전</td>
                                                    ...
                                                    <td>
                                                        <span class="refund-rate"><?= 100 - ($policies['cancellation']['fee_rates'][2]['fee_rate'] ?? 30) ?>%</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2시간 전</td>
                                                    ...
                                                    <td>
                                                        <span class="refund-rate"><?= 100 - ($policies['cancellation']['fee_rates'][3]['fee_rate'] ?? 50) ?>%</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2시간 미만</td>
                                                    ...
                                                    <td>
                                                        <span class="refund-rate"><?= 100 - ($policies['cancellation']['fee_rates'][4]['fee_rate'] ?? 100) ?>%</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
